...
GST_START_TEST (test_renegotiation)
{
  ...
  /*
    ...
    Priority : 1
  */
  source1 = audiotest_bin_src ("source1", 0 * GST_SECOND, 1 * GST_SECOND, 1, FALSE);
  check_start_stop_duration(source1, 0 * GST_SECOND, 1 * GST_SECOND, 1 * GST_SECOND);
  ...
  /*
    ...
    Priority : 1
  */
  source2 = audiotest_bin_src ("source2", 1 * GST_SECOND, 1 * GST_SECOND, 1, TRUE);
  ...
  /*
    ...
    Priority : 1
  */
  source3 = audiotest_bin_src ("source3", 2 * GST_SECOND, 1 * GST_SECOND, 1, FALSE);
  check_start_stop_duration(source3, 2 * GST_SECOND, 3 * GST_SECOND, 1 * GST_SECOND);
...
GST_START_TEST (test_one_bin_space_another)
{
  ...
  */
  ...
  /*
    ...
    Priority : 1
  */
  source2 = videotest_in_bin_gnl_src ("source2", 2 * GST_SECOND, 1 * GST_SECOND, 1, 1);
  fail_if (source2 == NULL);
  check_start_stop_duration(source2, 2 * GST_SECOND, 3 * GST_SECOND, 1 * GST_SECOND);
