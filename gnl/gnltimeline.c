...
GST_BOILERPLATE (GnlTimeline, gnl_timeline, GnlComposition, GNL_TYPE_COMPOSITION);
...
/* 	if (!gst_event_discont_get_value (GST_EVENT(buf), GST_FORMAT_TIME, (gint64 *) &(to_schedule->time))) */
...
static void
gnl_timeline_init (GnlTimeline *timeline, GnlTimelineClass *klass)
{
